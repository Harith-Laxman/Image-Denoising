...
model = load_model('models/model_050_dncnn-s.hdf5', custom_objects={'sum_squared_error': sum_squared_error})

file_list = glob.glob("images/set12" + "/*.png")
count = 0
for file in file_list:
    ...
    cv2.imwrite("images/denoised" + str(count + 1) + ".png", np.hstack((Y*255, tensor_output*255)))
    count = count + 1
